...
public class InitServiceImpl extends BaseRemoteServiceServlet implements InitService
{
    ...
    @Override
    public InitInfo initClient (final String referer, final String serverLogging)
    {
        ...
        if (null == browserIdCookie)
        {
            ...
            final String browserId = Utils.randomHexString(Constants.BROWSER_AUTH_TOKEN_BYTES);
